...
def button(msg, button_x, button_y, button_w, button_h, icolour, acolour, fontsize, action= None):
    # icolour = inactive colour & acolour = active colour
    global nresets
    ...
    if button_x+button_w > mouse_x > button_x and button_y+button_h > mouse_y > button_y:
        ...
        if click[0] == 1 and action!= None:
            if action == "level 1":
                time.sleep(0.2)
                Main.game_level("level 1", "level 2", "reset_level1", 2, 2, 4, 4, 5, 4, 3, 5, 3, 3, 1, 4,
                5, 0, 3, 4, 1, 2, 5, 3, 5, 0, 3, 4, 2, 2, 4, 4, 1, 2, 5, 3, 3, 3, 1, 4, 5, 4, 3, 5, 6, 28, 
                15, 29, 14, 24, 22, 26, 30, 34)
                ...
                if Main.nresets == -1:
                    ...
                    Main.game_level("level 1", "level 2", "reset_level1", 2, 2, 4, 4, 5, 4, 3, 5, 3, 3, 1, 4, 
                    5, 0, 3, 4, 1, 2, 5, 3, 5, 0, 3, 4, 2, 2, 4, 4, 1, 2, 5, 3, 3, 3, 1, 4, 5, 
                    4, 3, 5, 6, 28, 15, 29, 14, 24, 22, 26, 30, 34)
                ...
                if Main.nresets == -1:
                    ...
                    Main.game_level("level 2", "level 3", "reset_level2", 0, 1, 5, 3, 1, 1, 5, 4, 3, 1, 4,
                    4, 1, 3, 0, 5, 1, 2, 1, 4, 1, 3, 0, 5, 0, 1, 5, 3, 1, 2, 1, 4, 3, 1, 4, 4, 1, 
                    1, 5, 4, 20, 31, 7, 24, 14, 26, 10, 29, 8, 30)
                ...
                if Main.nresets == -1:
                    ...
                    Main.game_level("level 5", "game complete", "reset_level5", 1, 2, 3, 2, 2, 4, 4, 4, 1, 1, 
                    2, 5, 5, 0, 0, 5, 5, 1, 3, 5, 5, 0, 0, 5, 1, 2, 3, 2, 5, 1, 3, 5, 1, 1, 2, 5, 2, 4, 4, 4, 6, 31, 14,
                    16, 12, 34, 8, 33, 27, 29)

                
            elif action == "level 2":
                time.sleep(0.2)
                Main.game_level("level 2", "level 3", "reset_level2", 0, 1, 5, 3, 1, 1, 5, 4, 3, 1, 4, 4, 1, 3, 0, 5, 
                1, 2, 1, 4, 1, 3, 0, 5, 0, 1, 5, 3, 1, 2, 1, 4, 3, 1, 4, 4, 1, 1, 5, 4, 20, 31, 7, 24, 
                14, 26, 10, 29, 8, 30)
                ...
                time.sleep(0.2)
                Main.game_level("level 5", "game complete", "reset_level5", 1, 2, 3, 2, 2, 4, 4, 4, 1, 1, 
                2, 5, 5, 0, 0, 5, 5, 1, 3, 5, 5, 0, 0, 5, 1, 2, 3, 2, 5, 1, 3, 5, 1, 1, 2, 5, 2, 4, 4, 4, 6, 
                31, 14, 16, 12, 34, 8, 33, 27, 29)
    ...
    buttonText = Main.pygame.font.Font("freesansbold.ttf", fontsize)
